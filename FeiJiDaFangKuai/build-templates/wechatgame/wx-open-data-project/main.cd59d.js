(function () {
    ...
    function boot () {
        ...
        if (!false) {
            var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.d3921.js';
            if (jsList) {
    ...
    if (true) {
        require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.5137b.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.5137b.js';
